        ...
        <div class="post__author">
            <a class="post__author-link" href="#" title="<?= $post['login'] ?>">
                ...
                <div class="post__info">
                    ...
                    <time class="post__time" datetime="<?= $post['created_at'] ?>" title="<?= get_date_for_title($post['created_at']) ?>"><?= get_relative_date($post['created_at']) ?></time>
                </div>
            </a>
        </div>
